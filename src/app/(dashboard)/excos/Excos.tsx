...
const excos = [
  ...
  },
  {
    ...
    name: "Bolu Salami",
    icon: <Clipboard size={30} className="text-pink-500" />,
  ...
  },
  {
    role: "Treasurer",
    name: "Amaka Osueze",
    icon: <DollarSign size={30} className="text-green-500" />,
  ...
  },
  {
    ...
    icon: <Megaphone size={30} className="text-yellow-500" />,
...
const ExcosDisplay = () => {
  return (
    <div className="min-h-screen bg-gradient-to-rpy-12 px-4">
      <h2 className="text-2xl font-extrabold text-center m-6">
        AFSS07 2025 Excos
      </h2>
      <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4">
        {excos.map((exco, index) => (
          ...
          >
            <div className="mb-2">{exco.icon}</div>
            <div className="mb-2">
              <Image
                height={200}
                width={200}
